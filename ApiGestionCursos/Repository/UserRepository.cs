...
namespace ApiGestionCursos.Repository
{
    public class UserRepository : IUserRepository
    {
        ...
        public async Task<UserDataDto> Register(CreateUserDto createUserDto)
        {
            ...
            {
                throw new ArgumentNullException(nameof(createUserDto.Username), "El Username es requerido");
            }

            if (string.IsNullOrEmpty(createUserDto.Password))
            {
                throw new ArgumentNullException(nameof(createUserDto.Password), "El Password es requerido");
            }
